      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div class="space-y-8">
              ...
              <div class="space-y-4">
                <div class="flex items-center">
                  ...
                  <div>
                    ...
                    <p class="text-gray-300">123 Business Ave, Suite 100<br>San Francisco, CA 94105</p>
                  </div>
                </div>
                <div class="flex items-center">
                  <div class="bg-blue-600 p-3 rounded-lg mr-4">
                ...
                <div class="flex items-center">
                  ...
                  <div>
                    ...
                    <p class="text-gray-300">hello&#64;techcorp.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h4 class="text-xl font-semibold mb-4">Office Hours</h4>
            ...
            <div>
              ...
              <div class="flex space-x-4">
                <a href="#" class="bg-gray-700 p-3 rounded-lg hover:bg-blue-600 transition-colors">
